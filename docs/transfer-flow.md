...
`material_diagnostics.metadata_fields` 会按字段暴露 IMDb、TMDb、Douban URL/ID 和 PTGen/Douban 描述的 ready/required/source/value/length，`--print-shell` 也会导出对应的 `PTCLI_MATERIAL_METADATA_*_READY/SOURCE`，便于 AI 或盒子脚本判断该补 TMDb、豆瓣还是 PTGen 描述。
